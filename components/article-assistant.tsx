    ...
    <div className="fixed top-0 right-0 h-screen w-full lg:w-[500px] bg-background border-l border-border z-50 flex flex-col shadow-2xl">
        ...
        {isInitializing && (
          <div className="flex flex-col items-center justify-center h-full text-center p-6">
            ...
            <p className="text-sm text-muted-foreground max-w-md mb-4">
              {initProgress || "Downloading Llama 3.2 1B (~600MB)..."}
            </p>
            ...
            <p className="text-xs text-muted-foreground mt-4">
              First download takes 1-2 minutes, then instant on future visits
            </p>
          </div>
        )}
      ...
      <div className="p-4 border-t border-border bg-background">
        ...
        <p className="text-[10px] text-muted-foreground mt-2 text-center">
          Powered by Llama 3.2 1B running locally • 100% private
        </p>
      </div>
    </div>
  );
